...
const ToDoForm = ({ tasks, setTasks, editingTask, saveTask, cancelEdit }) => {
  const [taskInput, setTaskInput] = useState(editingTask || "");
  ...
  return (
    <div className="bg-white/80 p-6 rounded-lg shadow-lg w-full">
      <form onSubmit={handleFormSubmit}>
        <div className="mb-4">
          <label
            className="block text-lg font-semibold text-teal-700 mb-2"
            htmlFor="task"
          >
        ...
        <div className="flex justify-center space-x-4">
          <button
            type="submit"
            className={`px-6 py-2 font-semibold rounded-lg focus:outline-none transition transform hover:scale-105 shadow-md ${
              editingTask !== null
